        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent p-0 mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('agent.requests.index') }}">Solicitudes</a></li>
        ...
        <div class="col-lg-4">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('agent.requests.update', $request) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            <label for="admin_response">Respuesta / Notas</label>
